...
| **R-05** | Agent file tools bypass sandbox | 🔴 High | S-4 | ✅ **CLOSED** (floor) | `confinement.py`; `hermes.py:96-117,75-80` | `test_hermes_read_escape_denied`, `test_hermes_write_escape_denied`, `test_parent_traversal_denied`, `test_deep_traversal_denied`, `test_confinement_independent_of_provider` |
