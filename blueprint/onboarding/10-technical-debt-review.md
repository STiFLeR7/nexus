...
| TD-04 | **`AsyncMock` imported & used in production Hermes** + hardcoded plan/canned search | `hermes.py:7,145-149,183-209` | Hermes is partly a simulation, not a real agent |
